...
?>
        ...
        <p class="current_song">
            ...
            <img class="vol" src="img/volume.png">
            <input type="range" class="volume" max="1" min="0" value="1" step="0.1">
    </p>
    <p class="current_seek"><a class="start">0:00</a><input type="range" class="seek" max="223" min="0" value="0" step="1"><a class="end">2:22</a></p>
    <p class="current_duration">1</p>
    <p class="song"></p>
        </div>
